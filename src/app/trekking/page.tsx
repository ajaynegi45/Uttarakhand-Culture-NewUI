...
export default function Trekking() {
    return (<>
            ...
            <div className={styles["card-container"]}>
                ...
                <Card title={"PINDARI GLACIER TREK"} subTitle={"MODERATE · 3660m · BAGESHWAR"}
                      description={"The Pindari Glacier Trek takes you to the base of one of the most famous glaciers in the Kumaon Himalayas. The trek features beautiful alpine meadows, dense forests, and stunning views of the Nanda Devi and Panchachuli peaks. The glacier itself is a captivating sight, and the trek offers a chance to witness the pristine natural beauty of the region. The trek is known for its serene environment and picturesque landscapes."}
                      image={"/pindari_glacier.png"}
                />

                <Card title={"BALI PASS TREK"} subTitle={"DEMANDING · 4,950m · UTTARKASHI"}
                      description={"The Bali Pass Trek is a challenging adventure that crosses a high-altitude pass offering stunning views of the Garhwal Himalayas. The trek traverses through picturesque villages, lush forests, and alpine meadows before reaching the Bali Pass at 4,950 meters. The panoramic views from the pass are spectacular, with sights of peaks like Kedar Dome and the Swargarohini range. This trek is best suited for experienced trekkers due to its demanding nature and high altitude."}
                      image={"/bali_pass.png"}
                />

                <Card title={"KUMAON HIMALAYAS TREK"} subTitle={"MODERATE · 4,200m · KUMAON"}
                      description={"The Kumaon Himalayas Trek offers a diverse range of landscapes, from lush green valleys to rugged alpine terrain. The trek includes visits to picturesque villages, serene lakes, and high-altitude meadows. Highlights include views of the majestic Nanda Devi and Panchachuli peaks. This trek is known for its beautiful scenery, tranquil environment, and the opportunity to experience the unique culture of the Kumaon region."}
                      image={"/kumaon_himalayas.png"}
                />

                <Card title={"TUNGNATH CHOPTA TREK"} subTitle={"EASY · 3,680m · CHAMOLI"}
                      description={"The Tungnath Chopta Trek is a relatively easy trek that takes you to the highest Shiva temple in the world, Tungnath. The trek starts from the small town of Chopta and winds through lush green meadows and dense forests. The temple, located at an altitude of 3,680 meters, offers breathtaking views of the surrounding Himalayan peaks, including Chaukhamba and Trishul. This trek is ideal for those seeking a short yet rewarding adventure."}
                      image={"/tungnath_chopta.png"}
                />

                <Card title={"RUPIN PASS TREK"} subTitle={"DEMANDING · 4,650m · HIMACHAL PRADESH"}
                      description={"The Rupin Pass Trek is an exhilarating adventure that takes you from the lush green meadows of Uttarakhand to the rugged terrains of Himachal Pradesh. The trek involves crossing the Rupin Pass at an altitude of 4,650 meters, offering stunning views of the Dhauladhar and Kinnaur ranges. The trail includes diverse landscapes, from dense forests and gushing streams to snow-covered slopes and high-altitude meadows. This trek is suited for experienced trekkers looking for a challenging experience."}
                      image={"/rupin_pass.png"}
                />

                <Card title={"CHOPTA TO TUNGNATH AND BACK"} subTitle={"EASY · 3,680m · CHAMOLI"}
                      description={"This short trek from Chopta to Tungnath and back is a popular choice for those looking for a quick yet rewarding adventure. The trail passes through verdant meadows and forests, leading up to the Tungnath Temple. At an altitude of 3,680 meters, the temple offers panoramic views of the Himalayan peaks, including Trishul and Chaukhamba. The trek is perfect for beginners and those with limited time."}

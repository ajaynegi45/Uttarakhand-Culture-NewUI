	...
	return (
		<div>
			<div className={styles["uttarakhand-map"]}>
				<h1 className={styles["uttarakhand-map-heading"]}>
					Map of Uttarakhand
				</h1>
				...
				<div className={styles["zoom-button-container"]}>
					<p onClick={handleZoomIn} className={styles["zoom-level-button"]}>
						+
					</p>
					<p onClick={handleZoomOut} className={styles["zoom-level-button"]}>
						-
					</p>
				</div>
